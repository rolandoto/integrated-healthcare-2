  ...
  return (
    <>
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto grid gap-8 px-4 lg:grid-cols-2">
          <article className="rounded-2xl border border-primary-100 bg-primary-50 p-8 shadow-sm">
            ...
            <p className="leading-relaxed text-slate-700">We provide comprehensive psychiatric care.</p>
          </article>
          ...
          <article className="rounded-2xl border border-accent-100 bg-accent-50 p-8 shadow-sm">
            ...
            <p className="leading-relaxed text-slate-700">To be a trusted center of excellence in comprehensive psychiatry.</p>
          </article>
        </div>
      </section>
      ...
      <section className="bg-primary-900 py-16 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-center font-display text-3xl font-bold md:text-4xl">What Patients Say</h2>
          ...
          <div className="mx-auto mt-8 flex max-w-4xl flex-wrap justify-center gap-3">
            {socialLinks.map((social) => (
              <a key={social.label} href={social.href} target="_blank" rel="noreferrer" className="rounded-full border border-white/30 px-5 py-2.5 text-sm font-semibold transition hover:bg-white/10">
                {social.label}
              </a>
            ))}
          </div>
