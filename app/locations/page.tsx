...
const stores = [
  {
    id: 1,
    name: "Integrated Healthcare – Miami",
    subtitle: "Miami, FL 33126",
    address: "351 NW 42nd Ave. Suite 406, Miami, FL 33126",
    directionsAddress: "351+NW+42nd+Ave+Suite+406+Miami+FL+33126",
    phone: "(786) 536-1701",
  ...
  {
    id: 2,
    name: "Integrated Healthcare – Coral Gables",
    subtitle: "Miami, FL 33155",
    address: "1890 SW 57th Ave Suite 106, Miami, FL 33155",
    directionsAddress: "1890+SW+57th+Ave+Suite+106+Miami+FL+33155",
    phone: "(786) 536-1701",
    hours: "Mon – Sat: 9:00 AM – 5:00 PM",
    rating: 4.9,
    reviews: 72,
  ...
  {
    id: 3,
    name: "Integrated Healthcare – Hialeah",
    subtitle: "Hialeah, FL 33012",
    address: "900 West 49th Street, Ste 512, Hialeah, FL 33012",
    directionsAddress: "900+West+49th+Street+Ste+512+Hialeah+FL+33012",
    phone: "(786) 536-1701",
    hours: "Mon – Sat: 9:00 AM – 5:00 PM",
    rating: 4.8,
    reviews: 58,
  ...
  return (
    <>
      ...
      />
       ...
       <div className="flex flex-col lg:flex-row w-full" style={{ minHeight: "100dvh" }}>

      {/* ══════════════════════════════
          LEFT PANEL — clinic list
      ══════════════════════════════ */}
      <div className="w-full lg:w-[42%] lg:h-screen lg:overflow-y-auto bg-white lg:border-r border-gray-100 order-2 lg:order-1">
        <div className="px-4 py-6 sm:px-6 sm:py-8 lg:p-8">

          {/* Header */}
          <div className="mb-6 pb-5 border-b border-gray-100">
            <p className="text-xs tracking-widest uppercase text-[#00a878] font-semibold mb-1">
              Find a location
            </p>
            <h2 className="text-2xl sm:text-3xl font-serif text-gray-900 mb-1">
              {stores.length} Clinics near you
            </h2>
            <p className="text-sm text-gray-400">
              Tap a clinic to see details &amp; directions.
            </p>
          </div>
              ...
              return (
                <div
                  ...
                  className={`relative cursor-pointer rounded-xl border transition-all duration-200 overflow-hidden
                    ${isSelected
                      ? "border-[#00a878] shadow-md shadow-green-50 bg-green-50/30"
                      : "border-gray-200 bg-white hover:border-[#00a878] hover:shadow-sm"
                    }`}
                >
                  {/* Left accent bar */}
                  <div className={`absolute left-0 top-0 bottom-0 w-1 rounded-l-xl transition-colors duration-200
                    ${isSelected ? "bg-[#00a878]" : "bg-transparent"}`}
                  />
                  ...
                  <div className="p-4 sm:p-5 pl-5 sm:pl-6">
                    ...
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <div className="flex items-center gap-2.5 min-w-0">
                        {/* Number badge */}
                        <div className={`flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7 rounded-full flex items-center justify-center text-xs font-bold transition-colors
                          ${isSelected ? "bg-[#00a878] text-white" : "bg-gray-100 text-gray-500"}`}>
                          {index + 1}
                        </div>
                        <h3 className="text-sm sm:text-base font-semibold text-gray-900 font-serif leading-tight truncate">
                          {store.name}
                        </h3>
                      </div>
                      {/* Rating */}
                      <div className="flex items-center gap-1 flex-shrink-0">
                        ...
                        <span className="text-xs text-gray-400 hidden sm:inline">({store.reviews})</span>
                      </div>
                    </div>

                    {/* Address */}
                    <div className="flex items-start gap-2 text-xs sm:text-sm text-gray-500 mb-1.5 ml-8 sm:ml-9">
                      <svg className="w-3.5 h-3.5 mt-0.5 flex-shrink-0 text-[#00a878]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Hours */}
                    <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-500 ml-8 sm:ml-9">
                      <svg className="w-3.5 h-3.5 flex-shrink-0 text-[#00a878]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span>{store.hours}</span>
                    </div>

                    {/* Inline actions when selected — great for mobile */}
                    {isSelected && (
                      <div className="flex gap-2 mt-4 ml-8 sm:ml-9">
                        <a
                          href={getDirectionsUrl(store)}
                          target="_blank"
                          rel="noopener noreferrer"
                          onClick={(e) => e.stopPropagation()}
                          className="flex-1 bg-[#0a4a30] text-white text-xs font-bold py-2.5 px-3 rounded-lg text-center"
                        >
                          Get Directions
                        </a>
                        <a
                          ...
                          onClick={(e) => e.stopPropagation()}
                          className="flex-1 border-2 border-[#00a878] text-[#0a4a30] text-xs font-bold py-2.5 px-3 rounded-lg text-center"
                        >
                          Call Now
                        </a>
                      </div>
          ...
          {/* CTA block */}
          <div className="mt-6 p-4 sm:p-5 bg-[#0a4a30] rounded-xl">
            <p className="text-xs tracking-widest uppercase text-[#7ecfb0] mb-1">Need help?</p>
            <p className="text-white font-serif text-base sm:text-lg mb-3">Call us directly</p>
            <a
              href="tel:7865361701"
              className="inline-flex items-center gap-2 bg-[#00a878] text-white text-sm font-bold px-4 py-2.5 rounded-lg"
            >
      ...
      {/* ══════════════════════════════
          RIGHT — MAP
      ══════════════════════════════ */}
      <div className="w-full lg:w-[58%] h-[55vw] min-h-[280px] max-h-[420px] sm:max-h-[500px] lg:max-h-none lg:h-screen lg:sticky lg:top-0 order-1 lg:order-2 relative">
        <LoadScript googleMapsApiKey="AIzaSyB5gsEN5HLPh4Q9RdCImZZVR71A-cXkY2Y">
          ...
          >
                  ...
                  icon={{
                    url: isSelected
                      ? "data:image/svg+xml;charset=UTF-8," + encodeURIComponent(`
                          <svg width="44" height="56" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22 0C10 0 0 10 0 22c0 16 22 34 22 34s22-18 22-34C44 10 34 0 22 0z" fill="#0a4a30"/>
                            <circle cx="22" cy="21" r="10" fill="white"/>
                            <circle cx="22" cy="21" r="6" fill="#00a878"/>
                          </svg>`)
                      : "data:image/svg+xml;charset=UTF-8," + encodeURIComponent(`
            ...
            {/* ── Airbnb popup — desktop only (hidden on mobile via CSS trick) ── */}
            {selectedStore && (
              <OverlayView
                    ...
                    <div style={{ padding: "14px 16px 6px", background: "#fff" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "6px" }}>
                        <div style={{ flex: 1, paddingRight: "8px" }}>
                          <p style={{ margin: 0, fontWeight: "700", fontSize: "14px", color: "#111", lineHeight: 1.3 }}>{selectedStore.name}</p>
        ...
        {selectedStore && (
          <div className="lg:hidden absolute bottom-0 left-0 right-0 z-50 bg-white rounded-t-2xl shadow-2xl">
            {/* Drag handle */}
            ...
            <div className="relative h-36 overflow-hidden">
              ...
              >
                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#333" strokeWidth="3">
                  <path d="M18 6L6 18M6 6l12 12" />
                </svg>
              </button>
              {/* Dots */}
              <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1">
                {selectedStore.images.map((_, i) => (
                  <div key={i} className={`rounded-full transition-all ${i === imgIndex ? "w-2 h-2 bg-white" : "w-1.5 h-1.5 bg-white/50"}`} />
                ))}
              </div>
            </div>
            ...
            <div className="px-4 pt-3 pb-2">
              <div className="flex justify-between items-start mb-1">
                <p className="font-bold text-sm text-gray-900 leading-snug flex-1 pr-2">{selectedStore.name}</p>
                <div className="flex items-center gap-1 flex-shrink-0">
                  <StarIcon />
                  <span className="text-xs font-semibold text-gray-700">{selectedStore.rating}</span>
                  <span className="text-xs text-gray-400">({selectedStore.reviews})</span>
                </div>
              </div>
              <p className="text-xs text-gray-500 mb-0.5">📍 {selectedStore.address}</p>
              <p className="text-xs text-gray-500">🕐 {selectedStore.hours}</p>
            </div>
            ...
            <div className="flex gap-3 px-4 pb-6 pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-[#0a4a30] text-white text-sm font-bold py-3 rounded-xl text-center"
              >
                Get Directions
              </a>
              <a
                href={`tel:${selectedStore.phone.replace(/\D/g, "")}`}
                className="flex-1 border-2 border-[#00a878] text-[#0a4a30] text-sm font-bold py-3 rounded-xl text-center"
              >
                Call Now
              </a>
            </div>
